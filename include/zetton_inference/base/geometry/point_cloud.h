...
#include "zetton_inference/base/geometry/point.h"
...
using PointFCloud = AttributePointCloud<PointF>;
using PointDCloud = AttributePointCloud<PointD>;

using PointFCloudPtr = std::shared_ptr<PointFCloud>;
using PointFCloudConstPtr = std::shared_ptr<const PointFCloud>;

using PointDCloudPtr = std::shared_ptr<PointDCloud>;
using PointDCloudConstPtr = std::shared_ptr<const PointDCloud>;

// typedef of polygon
using PolygonFType = PointCloud<PointF>;
using PolygonDType = PointCloud<PointD>;

using PolygonFTypePtr = std::shared_ptr<PolygonFType>;
using PolygonFTypeConstPtr = std::shared_ptr<const PolygonFType>;

using PolygonDTypePtr = std::shared_ptr<PolygonDType>;
using PolygonDTypeConstPtr = std::shared_ptr<const PolygonDType>;
